...
class VC_EX_CON3(Constraint[str, str]):
    ...
    def satisfied(self, assignment: Dict[str, str]) -> bool:
        ...
        return (assignment[self.place1] == "N-Graphic" | assignment[self.place1] == "A-Graphic") | \
               (assignment[self.place2] == "Server" | assignment[self.place2] == "Gaming")

        # if assignment[self.place1] == "N-Graphic" | assignment[self.place1] != "A-Graphic":
        #     if assignment[self.place2] == "Server" | assignment[self.place2] == "Gaming":
        #         return True
        #
        # return False
